...
import { 
  ...
  DirectionsWalkOutlined as WalkIcon,
  LandscapeOutlined as HikeIcon,
  HikingOutlined as HikingIcon,
  DownhillSkiingOutlined as SkiIcon,
  SnowboardingOutlined as SnowboardIcon,
  SurfingOutlined as SurfingIcon,
  SportsGymnasticsOutlined as YogaIcon,
  RowingOutlined as RowingIcon,
  SportsKabaddiOutlined as CrossfitIcon,
  FitnessCenterOutlined as WeightTrainingIcon,
  SkateboardingOutlined as SkateboardIcon,
  SportsGolfOutlined as GolfIcon,
  SportsHandballOutlined as HandcycleIcon,
  AccessibleForwardOutlined as WheelchairIcon,
  SportsScoreOutlined as TrackIcon,
  SportsEsportsOutlined as VirtualIcon,
  KayakingOutlined as KayakingIcon,
  SailingOutlined as SailingIcon,
  WavesOutlined as WaterSportIcon,
  AcUnitOutlined as IceSkateIcon,
  SnowshoeingOutlined as SnowshoeIcon,
  SportsHockeyOutlined as StickSportIcon,
  AccessTimeOutlined as OtherIcon,
